...
- rewrite Ztrunc_ceil in H by (apply Rlt_le; auto). split.
  + apply Ropp_lt_cancel. try rewrite Ropp_involutive.
    try rewrite <- Ropp_Ropp_IZR. simpl.
...
Proof.
  ...
  { unfold round. simpl.
    ...
    { apply Zfloor_imp.
      ...
      (rewrite <- Rinv_1 at 3 || rewrite <- Rinv_1). apply Rinv_1_lt_contravar. apply Rle_refl. apply (Z2R_lt 1 2). omega.
    }
